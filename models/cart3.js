...
cart3: add the remove by 1 method as well as the remove all method to make the buttons in the view functional. Make sure to add routes to index file.

cart4: (not in videos) added function to add any amount to cart.
*/
