...
index10: video 14: (see note) add /checkout route with basic callback function.  In the callback function, the first thing we want to do is to see if the cart
