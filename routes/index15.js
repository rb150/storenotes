...
index14: (also, copied different stripe documenation code: 
video 18. copy the isLoggedIn function from the user routes and change the redirect route to users/signing.  Then use it in the checkout get and post routes.  
Next we change the res.redirect in the isLoggedIn function to /user/signin. 

index15: video 20.  Add routes for the buttons to removal buttons.  Can name them whatever you want. Added after 'add-to-cart' route.
*/
